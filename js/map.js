        ...
        function populateInfoWindow(marker, infowindow) {
          ...
          $.ajax({
            ...
            if (infoUrl === undefined) {
              ...
              infowindow.setContent('<div>' + '<h4>' + marker.title + '</h4>' + '<h5>' + marker.category + '</h5>' + '<h6>' + '<p>' + 'Website : ' + marker.website +'</p>' + '</h6>' + '<h6>' + '<p>' + 'Address : ' + marker.address + '</p>' +'</h6>' + '<p>' + infoDescription + '<a href="' + infoUrl + '" target="blank">' + '..' + ' Read More' + '</a>' + '</p>' + '</div>');
              infowindow.open(map, marker);
            }
